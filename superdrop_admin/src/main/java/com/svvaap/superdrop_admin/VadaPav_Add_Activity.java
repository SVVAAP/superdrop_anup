...
public class VadaPav_Add_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vada_pav_add);

        mButtonChooseImage = findViewById(R.id.vada_img_bt);
        mButtonUpload = findViewById(R.id.vada_upload_bt);
        //mTextViewShowUploads = findViewById(R.id.text_view_show_uploads);
        mEditTextFileName = findViewById(R.id.vada_item_name);
        mImageView = findViewById(R.id.vada_item_img);
        mProgressBar = findViewById(R.id.vada_progressBar);
        mEditTextPrice = findViewById(R.id.vada_item_price);

        mStorageRef = FirebaseStorage.getInstance().getReference("vadapavexpress");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("vadapavexpress");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(VadaPav_Add_Activity.this, "Upload in progress", Toast.LENGTH_SHORT).show();
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(VadaPav_Add_Activity.this, "Upload successful", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(VadaPav_Add_Activity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
