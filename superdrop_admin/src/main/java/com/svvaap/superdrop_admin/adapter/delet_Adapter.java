...
public class delet_Adapter extends RecyclerView.Adapter<delet_Adapter.RestImageVHolder>{
    ...
    @NonNull
    @Override
    public RestImageVHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(rcontext).inflate(R.layout.rest_item_v, parent, false);
        return new RestImageVHolder(v,this);
    }

    @Override
    public void onBindViewHolder(@NonNull RestImageVHolder holder, int position) {
